...
class GuideFragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_guide_emergancy_01, container, false)
    ...
    private fun handleGuideSelection(selectedLayout: ConstraintLayout, guideId: String) {
        ...
        if (selectedGuideLayout == selectedLayout) {
            ...
            callback?.onGuideSelected(null, "GuideFragment1")  // 선택 해제 상태 전달
        } else {
            // 이전 선택 항목 해제
            ...
            callback?.onGuideSelected(guideValue, "GuideFragment1")
        }
    }
