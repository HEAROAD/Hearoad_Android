...
class MoneyGuideFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_guide_money_02, container, false)
    ...
    private fun handleGuideSelection(selectedLayout: ConstraintLayout, guideId: String) {
        ...
        if (selectedGuideLayout == selectedLayout) {
            ...
            callback?.onGuideSelected(null, "MoneyGuideFragment2")  // 선택 해제 상태 전달
        } else {
            // 이전 선택 항목 해제
            ...
            callback?.onGuideSelected(guideValue, "MoneyGuideFragment2")
        }
    }
