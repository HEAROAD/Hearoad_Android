...
class GuideFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_guide_emergancy_02, container, false)
        ...
        // 이전에 저장된 선택 상태 불러오기
        loadSelectedGuide(guide1Layout, guide2Layout, guide3Layout, guide4Layout, guide5Layout)
    ...
    private fun handleGuideSelection(selectedLayout: ConstraintLayout, guideId: String) {
        ...
        if (selectedGuideLayout == selectedLayout) {
            ...
            callback?.onGuideSelected(null, "GuideFragment2")  // 선택 해제 상태 전달
        } else {
            // 이전 선택 항목 해제
            ...
            callback?.onGuideSelected(guideValue, "GuideFragment2")
        }
    }
    ...
    private fun saveSelectedGuide(guide: String) {
        ...
        editor.putString("selected_guide_2", guide)  // 'selected_guide_2' key로 저장
        editor.apply()
    }
