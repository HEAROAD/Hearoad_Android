...
class GuideActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set click listeners for guide options
        clGuide1.setOnClickListener { selectGuide(clGuide1, "guide_1", "다쳤어요") }
        clGuide2.setOnClickListener { selectGuide(clGuide2, "guide_2", "아파요") }
        clGuide3.setOnClickListener { selectGuide(clGuide3, "guide_3", "사라졌어요") }
        clGuide4.setOnClickListener { selectGuide(clGuide4, "guide_4", "제3자에게 위협을 당했어요") }
    ...
    private fun selectGuide(selectedLayout: ConstraintLayout, guideKey: String, guideText: String) {
        selectedGuide?.isSelected = false  // Deselect the previous selection
        selectedLayout.isSelected = true   // Select the current layout
        selectedGuide = selectedLayout     // Remember the current selection

        // Save the selected guide text to SharedPreferences
    ...
    private fun handleNextButtonClick() {
        val intent = Intent(this, ChatroomActivity::class.java) // Replace with the actual next activity
